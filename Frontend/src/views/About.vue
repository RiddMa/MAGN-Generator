    ...
    <a-row class="toImage" id="toImage" ref="toImage">
      ...
      <a-col :xxl="14" :xl="16" :lg="18" :md="20" :sm="22" :xs="24">
        <a-card class="aboutCard">
          ...
          <a-typography-paragraph class="aboutText">
            前往“Home”页面。<br/>在“选项”中填写影片英文标题、中文标题、年份，并在下方勾选影片所属类型。（影片分类参考了
            <a-typography-link
            ...
            ）<br/>点击“清空全部”按钮可以清空关于影片的所有信息。（包括影片本身信息及打分、评论）<br/>在下方卡片，可以预览生成海报图片样式。<br/>从四个维度，点击星星来进行打分（评分维度参考了学院奖奖项设置）。<br/>在最下方输入框，输入影评内容。
          </a-typography-paragraph>
          <a-typography-title class="aboutTitle" :level="2"
            >相关链接
          </a-typography-title>
